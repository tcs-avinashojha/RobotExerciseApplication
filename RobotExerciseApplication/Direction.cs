namespace RobotExerciseApplication
{
    internal static class Direction
    {
        ...
        private static readonly LinkedList<string> _directions = new LinkedList<string>(new[] { North, East, South, West });

        public static bool IsValid(this string direction) => _directions.Contains(direction);
